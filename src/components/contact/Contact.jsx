...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (clientName && email && EmailValidation(email) && messages) {
      axios.post("https://getform.io/f/eaf0bfe8-b508-4f86-9757-37b2cbb06602", {
        name: clientName,
        email: email,
        message: messages,
      });
    ...
    <div className="w-full">
      ...
      <div className="w-full mt-10">
        ...
        {seuccessMsg ? (
          ...
          <form
            id="form"
            action="https://getform.io/f/eaf0bfe8-b508-4f86-9757-37b2cbb06602"
            method="POST"
